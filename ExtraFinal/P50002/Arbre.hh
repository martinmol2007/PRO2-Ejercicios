...
class Arbre {
 ...
 public:
     ...
     * imatge especular del seu fill dret. Dos arbres són imatge especular
     * l'un de l'altre quan tots dos són buits, o bé tenen la mateixa arrel
     * i, a més, el fill esquerre del primer és imatge especular del fill
    ...
    bool is_symmetric() const {
        return is_symmetric_aux(primer_node);
    }
 private:
    static bool is_symmetric_aux(node_arbre* n) {
        if(n == nullptr) return true;
        if(n->segE != nullptr && n->segD != nullptr) return n->segE->info == n->segD->info;
        
        return is_symmetric_aux(n->segE) && is_symmetric_aux(n->segD);
    }
    //////////////////////////////////////////////////////////////////////////////
};
